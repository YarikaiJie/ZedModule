...
import com.module.kotlin.filelog.LogFileManager.getLogRoot
...
object FileLog {
    ...
    private val logDir by lazy(LazyThreadSafetyMode.NONE) { getLogRoot() + File.separatorChar }
    ...
    fun write(log: String, needStace: Boolean = false, throwable: Throwable? = null) {
        val logTimeStr =  System.currentTimeMillis().millisToStr("yyyy-MM-dd HH:mm:ss.ms")
