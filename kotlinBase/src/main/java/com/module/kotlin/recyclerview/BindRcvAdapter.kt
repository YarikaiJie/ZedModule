...
import com.module.kotlin.utils.withMainThread
 ...
 *
 * 在[androidx.recyclerview.widget.RecyclerView.Adapter.onCreateViewHolder]中使用create()函数来创建viewHolder。
 *
 */
abstract class BindRcvAdapter<DATA:Any, VH: BindViewHolder<DATA, *>> : BaseAdapter<DATA, VH>(),
    IBindAdapter<DATA> {
